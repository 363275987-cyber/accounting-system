...
const routes = [
  ...
  { 
    ...
    children: [
      ...
      { path: 'platform-integration', name: 'PlatformIntegration', component: () => import('../views/PlatformIntegration.vue'), meta: { roles: ['admin', 'finance', 'manager'] } },
      { path: 'platform-orders', name: 'PlatformOrders', component: () => import('../views/PlatformOrders.vue'), meta: { roles: ['admin', 'finance', 'manager'] } },
      ...
      { path: 'ecommerce', name: 'Ecommerce', component: () => import('../views/Ecommerce.vue'), meta: { roles: ['admin', 'finance', 'manager'] } },
      { path: 'ecommerce-orders', name: 'EcommerceOrders', component: () => import('../views/EcommerceOrders.vue'), meta: { roles: ['admin', 'finance', 'manager'] } },
